...
# Use the engine to connect and execute SQL statements
with engine.connect() as connection:
    # Execute SQL sentences to create your tables
    ...
    # Execute SQL sentences to insert data
    connection.execute(text("""
...
# Use pandas to print one of the tables as a DataFrame
